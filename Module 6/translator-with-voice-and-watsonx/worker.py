...
def watsonx_process_message(user_message):
    ...
    prompt = f"""You are an assistant helping translate sentences from English into other languages.
    Translate the query to the language mentioned in the query: ```{user_message}```."""
